...
const SKIP = new Set([
  ...
  // Auto-generated icon catalog (all Lucide icons) — a whole-page listing, not an ordinary
  // preview; regenerated by build:css. Also excluded from check-icon-coverage.sh.
  'icons-lucide'
]);
