...
- Theme CSS lives at `zul/src/main/resources/web/js/zul/wgt/css/{badge,chip,avatar,avatargroup}.css`
...
`native-severity-naming-proposal.md` (retired with the template).
